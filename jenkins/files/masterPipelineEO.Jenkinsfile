...
pipeline {
    ...
    parameters {
        ...
        string(
            name: 'NAMESPACE',
            defaultValue: 'hallXXX-eric-eic-N',
        ...
        string(
            name: 'INGRESS_CLASS',
            defaultValue: 'default',
            description: 'INGRESS class name (default, oss_iccr, etc.)'
        )
    ...
    stages {
        ...
        stage ('PREINSTAL'){
            ...
            steps{
                ...
                build job: 'EO_deploy_preinstall', parameters: [string(name: 'SFTP_USER_SECRET', value: "${params.SFTP_USER_SECRET}"),string(name: 'VNFM_REGISTRY_HOSTNAME', value: "${params.VNFM_REGISTRY_HOSTNAME}"), string(name: 'DEPLOYMENT_TYPE', value: "${params.DEPLOYMENT_TYPE}"), string(name: 'NAMESPACE', value: "${params.NAMESPACE}"), string(name: 'KUBECONFIG_FILE', value: "${params.KUBECONFIG_FILE}"), string(name: 'IDUN_USER_SECRET', value: "${params.IDUN_USER_SECRET}"), string(name: 'SLAVE_LABEL', value: "${env.SLAVE_LABEL}"), string(name: 'CRD_NAMESPACE', value: "${params.CRD_NAMESPACE}"), string(name: 'ARMDOCKER_USER_SECRET', value: "${params.ARMDOCKER_USER_SECRET}")]
        ...
        stage ('INITIAL INSTALL'){
            ...
            steps {
                ...
                build job: 'EO_deploy_helmfile', parameters: [
                 ...
                 string(name: 'FULL_PATH_TO_SITE_VALUES_FILE', value: "${params.FULL_PATH_TO_SITE_VALUES_FILE}"),
                 ...
                 string(name: 'INGRESS_CLASS', value: "${params.INGRESS_CLASS}"),
