...
pipeline {
    ...
    stages {
	    ...
	    steps {
                ...
                sh "kubectl --kubeconfig ./admin.conf annotate --overwrite namespace ${NAMESPACE} eo-version=\"${INT_CHART_VERSION}\" "
                sh """
                    ...
                    kubectl --kubeconfig ./admin.conf annotate --overwrite configmap ${NAMESPACE} -n bookings eo-version=\"${INT_CHART_VERSION}\" 
                    kubectl --kubeconfig ./admin.conf annotate --overwrite configmap ${NAMESPACE} -n bookings eiap-version=\"N/A\"
