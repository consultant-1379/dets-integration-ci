    ...
    stages {
        ...
        stage ('GET ENVIRONMENT'){
            steps{
                ...
                script{
                    build job: 'EIAP_shared_deploy_getEnv', parameters: [
...
""")
        ...
        stage ('TEARDOWN'){
            ...
            steps{
                ...
                build job: 'EIAP_shared_deploy_teardown', parameters: [
        ...
        stage ('PREINSTAL'){
            ...
            steps{
                ...
                build job: 'EIAP_shared_deploy_preinstall', parameters: [
        ...
        stage ('INITIAL INSTALL'){
            ...
            steps {
                ...
                build job: 'EIAP_shared_deploy_helmfile', parameters: [
        ...
        stage ('POSTCHEKS'){
            ...
            steps{
                ...
                build job: 'EIAP_shared_deploy_postchecks', parameters: [
